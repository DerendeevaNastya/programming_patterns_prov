...
namespace Xrm.ReportUtility.Services
{
    public abstract class ReportServiceBase : IReportService
    {
        ...
        // это фасад (простой интерсейс к сложной системе классов)
        // (получение dataTransformer, парсер для конфига, чтение файла, преобразование данных) - довольно
        // сильно упрощает взаимодействие с системой классов
